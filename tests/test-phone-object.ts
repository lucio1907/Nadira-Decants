...
async function test() {
  ...
  global.fetch = async (url, options) => {
    if (url.toString().includes("shipping/import")) {
      ...
      // Test hypothesis: phone is an object
      body.recipient.phone = { areaCode: "3329", number: "402087" };
      body.recipient.cellPhone = { areaCode: "3329", number: "402087" };
  ...
  try {
    ...
    console.log("[SUCCESS] Label generated successfully with phone as object!");
  } catch (err: any) {
